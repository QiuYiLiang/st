...
void xhints(void) {
  ...
  sizeh->base_width = 2 * wborderpx;
  sizeh->min_height = win.ch + 2 * borderpx;
  sizeh->min_width = win.cw + 2 * wborderpx;
  if (xw.isfixed) {
...
void xinit(int cols, int rows) {
  ...
  win.w = 2 * win.hborderpx + 2 * wborderpx + cols * win.cw;
...
void xximspot(int x, int y) {
  ...
  xw.ime.spot.x = wborderpx + x * win.cw;
